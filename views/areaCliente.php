            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
						<a href="../views/editarCadastroCliente.php">Editar cadastro</a>
                    </li>
					<li class="page-scroll">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h5>Área Restrita do Cliente</h5>
				...
				<div class="row" >
					<div class="col-lg-12 text-center">
						...
						<form class="form-signin" method="POST" action="../controllers/profissionalController.php"  >
							...
							<select class="form-control" name="selecionar_profissao" id="txt_plataforma" >
							...
							<div class= "col-lg-offset-12">
								<button  class="btn btn-primary" type="submit">
									...
									<input type="hidden" name="acao" id="acao" value="clienteBuscaPorProfissao">
								</button>
							</div>
