...
<?php
	...
	if (empty($validar)){
		...
		$cadastroProfissionalModel = $profissionalController->mostrarDadosProfissional($validar);
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
		            ...
		            <li class="page-scroll">
						...
						<a href="../views/areaProfissional.php">Retornar a área restrita</a>
	...
	<div class="container" >
		...
		<div>
			...
			<h6> <?php echo "Seja bem-vindo(a) ". $validar;?> </h6> 
				...
				<p><center style="color:red;">
					<?php
						if(isset($_SESSION['emailDoProfissionalDiferente'])){
							echo $_SESSION['emailDoProfissionalDiferente'];
							unset ($_SESSION['emailDoProfissionalDiferente']);
						}
					?>
				</center></p>
				...
				<p><center style="color:ciano;">
					<?php
						if(isset($_SESSION['atualizacaoCPF'])){
							echo $_SESSION['atualizacaoCPF'];
							unset ($_SESSION['atualizacaoCPF']);
						}
					?>
				</center></p>
			</br>
		...
		<form   method="POST" action="../controllers/profissionalController.php">
			...
			<div  class="col-sm-4 form-group">
				...
				<input type="hidden" name="acao" id="acao" value="editarCadastroProfissional">
