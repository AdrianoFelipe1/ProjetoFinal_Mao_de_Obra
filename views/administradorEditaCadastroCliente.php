...
<?php
	...
	if (empty($validar)){
		...
		$id_cliente = $_GET['id'];
		$_SESSION["id_clienteEdita"] = $id_cliente;
		
		$clienteController = new clienteController();
		$cadastroClienteModel = $clienteController->mostrarDadosClienteId($id_cliente);
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
		            ...
		            <li class="page-scroll">
						...
						<a href="../views/areaAdministradorClientes.php">Retornar aos dados dos clientes</a>
	...
	<div class="container">
		<div>
			...
			<p><center style="color:ciano;">
					<?php
						if(isset($_SESSION['atualizacaoClienteId'])){
							echo $_SESSION['atualizacaoClienteId'];
							unset ($_SESSION['atualizacaoClienteId']);
						}
					?>
				</center></p>
			...
			<p><center style="color:red;">
					<?php
						if(isset($_SESSION['EmailCliJaCadastrado'])){
							echo $_SESSION['EmailCliJaCadastrado'];
							unset ($_SESSION['EmailCliJaCadastrado']);
						}
					?>
				</center></p>
		...
		<form   method="POST" action="../controllers/clienteController.php">
			...
			<div  class="col-sm-4 form-group">
				...
				<input type="hidden" name="acao" id="acao" value="editarCadastroClienteId">
