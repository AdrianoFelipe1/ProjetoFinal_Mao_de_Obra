<?php
	...
	if (empty($validar)){
		...
		$listaCadastrosProfissionais = $profissionalController->exibirDadosProfissionais();
	}
...
<body id="page-top" class="index">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
					 ...
					 <p><center style="color:ciano;">
						<?php
							if(isset($_SESSION['excluirProf'])){
								echo $_SESSION['excluirProf'];
								unset ($_SESSION['excluirProf']);
							}
			...
			<table  class="table" class="img-responvive" >
				...
				<tbody>
					<tr>
						...
						$cont = 1;
							...
							foreach($listaCadastrosProfissionais as $itemLista){
							...
							echo "<td>".$itemLista->getServicoModel()->getNome_serv()."</td>" ;
							
						 	echo "<td>".$itemLista->getProfissionalModel()->getNome_pro()."</td>";

							echo "<td>".$itemLista->getProfissionalModel()->getCidade_pro()."</td> ";
							
							echo "<td>".$itemLista->getProfissionalModel()->getEstado_pro()."</td>";
						
							echo "<td>".$itemLista->getProfissionalModel()->getTelefone_pro()."</td>";
							
							echo "<td>".$itemLista->getProfissionalModel()->getEmail_pro()."</td>";
	
	
							echo" <td><a href='administradorEditaCadastroProfissional.php?id=".$itemLista->getProfissionalModel()->getId_pro()."'><button class='btn btn-lg btn-primary btn-block' type='submit' ><img src=\"../imagens/edit.png\"a href='#'></button>
							<input type='hidden' name='acao' id='".$itemLista->getProfissionalModel()->getId_pro()."' value='mostrarDadosProfissionalId'></a></td>";
							
							echo" <td><a  href='excluiProfissional.php?idLogin=".$itemLista->getProfissionalModel()->getId_login_pro()."'><button class='btn btn-lg btn-primary btn-block' type='submit'Onclick=\"return deleta();\" excluir ><img src=\"../imagens/delete.png\"</a></button>
							<input type='hidden' name='acao' id='".$itemLista->getProfissionalModel()->getId_login_pro()." value='XXX'></a></td></tr>";
