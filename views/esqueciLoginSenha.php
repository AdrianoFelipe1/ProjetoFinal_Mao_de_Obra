       ...
       <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                   ...
                   </br> <h5>Recuperação de Login e Senha</h5></br>
            </div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="col-lg-10 col-lg-offset-2 text-center">
							<a href="../views/loginSenhaCliente.php" class="btn btn-lg btn-outline">Se você é um Cliente clique aqui</a>
						</div>
					</div>
					...
					<div class="col-lg-4">
						...
						<div class="col-lg-8 col-lg-offset-2 text-center">
							<a href="../views/loginSenhaProfissional.php" class="btn btn-lg btn-outline">Se você é um Profissional clique aqui </span></a>
						</div>
                </div>
